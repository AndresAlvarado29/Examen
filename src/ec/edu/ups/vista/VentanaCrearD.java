 ...
 * @author Andres
 */
public class VentanaCrearD extends javax.swing.JInternalFrame {
private ControladorDocente controladorDocente;
    /**
     * Creates new form VentanaCrearD
     */
    public VentanaCrearD(ControladorDocente controladorDocente) {
        initComponents();
        ...
        if (txtCedula.getText().equals("")||txtNombre.getText().equals("")||txtApellido.getText().equals("")||txtDireccion.getText().equals("")||txtContraseña.getText().equals("")||txtUsuario.getText().equals("")) {
            ...
            if (txtCedula.getText().length()==10) {
                if (txtContraseña.getText().length()==8) {
                    Docente a= new Docente(txtCedula.getText(),txtNombre.getText(),txtApellido.getText(),txtDireccion.getText(),txtContraseña.getText(),txtUsuario.getText());
